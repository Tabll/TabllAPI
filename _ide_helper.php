 ...
 * Generated for Laravel 7.14.1 on 2020-06-09 13:43:21.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::success($messages);
        }
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::error($errorCode, $errorMessage);
        }
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::abandon();
        }
